    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <%
                    BeanPeriod period = (BeanPeriod) request.getAttribute("period");
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col">
                            <form class="row g-3 needs-validation" novalidate action="update-period-confirm" method="post">
                                <div class="col-md-4">
                                    <label for="validationCustom01" class="form-label fw-bold">Nombre:</label>
                                    <input type="text" class="form-control" id="validationCustom01" value="<%= period.getName()%>" required
                                           name="name">
                                    <div class="invalid-feedback">
                                        Campo obligatorio.
                                    </div>
                                    <input type="hidden" name="id" id="id" value="<%= period.getId()%>">
                                </div>
                                <div class="col-md-4">
                                    <label for="validationCustom02" class="form-label fw-bold">Tipo:</label>
                                    <input type="text" class="form-control" id="validationCustom02" value="<%= period.getType()%>" required
                                           name="type">
                                    <div class="invalid-feedback">
                                        Campo obligatorio.
                                    </div>
                                ...
                                <div class="col-6">
                                    ...
                                    <input type="date" class="form-control" id="validationCustom06" value="<%= period.getStartDate()%>" required
                                           name="startDate">
                                    <div class="invalid-feedback">
                                        Campo obligatorio.
                                    </div>
                                ...
                                <div class="col-6">
                                    ...
                                    <input type="date" class="form-control" id="validationCustom07" value="<%= period.getEndDate()%>" required
                                           name="endDate">
                                    <div class="invalid-feedback">
                                        Campo obligatorio.
                                    </div>
                                ...
                                <div class="col-6">
                                    ...
                                    <select class="form-select form-select-sm" aria-label=".form-select-sm example" id="validationCustom08"
                                            name="quarterId">
                                        <option value="<%= period.getQuarterId()%>" selected><%= period.getQuarterName()%></option>
                                        <%
